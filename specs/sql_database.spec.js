...
describe('SQL Database Tests', () => {
    ...
    test(`Schema - number of columns of customers is: ${customersColumnName.length}`, async () => {    
        ...
        expect(numberOfColumns[0].numberOfColumns).toBe(customersColumnName.length);
    });
    ...
    test('Schema - different properties of columns customers table', async () => {    
        ...
        expect(columnNamesProperties).toEqual(customersColumnProperties);
        // console.table(columnNamesProperties);
        // const columnNamesArrayJson = JSON.parse(JSON.stringify(columnNamesProperties));
